...
export const Route = createFileRoute("/international-services")({
  ...
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "MAKX Commercials | Outsourced bookkeeping for US, UK, Australian & Canadian firms",
      },
      {
...
const QUOTE_STEPS = [
  { icon: FileSearch, title: "1. Discovery Call", body: "A short call to understand your workflow, volumes, tools and where you need support." },
  { icon: ClipboardCheck, title: "2. Written Proposal", body: "A clear scope and quotation — task-based, monthly retainer, or dedicated staffing, whichever fits." },
  { icon: Rocket, title: "3. Onboard & Start", body: "Once terms are agreed, we set up access and get to work inside your existing systems." },
];
            ...
            <div className="mt-12 grid gap-6 lg:grid-cols-2">
                  ...
                  {SECURITY_POINTS.map((point, i) => {
                    ...
                    return (
                      <li key={point} className="flex gap-3 text-sm leading-relaxed text-muted-foreground">
                        <Icon className="mt-0.5 h-4.5 w-4.5 shrink-0 text-teal" aria-hidden="true" />
                        {point}
                      </li>
                    );
                  })}
              ...
              <Reveal delay={110}>
                <div className="flex h-full gap-5 rounded-3xl gradient-hero p-7 shadow-lift">
                  ...
                  <div>
                    <h3 className="font-display text-lg font-bold text-white">Who you're working with</h3>
                    <p className="mt-2.5 text-sm leading-relaxed text-white/70">
                      MAKX is led by a team of expert accountants, with an ACCA-qualified
                      professional at the helm, fluent in both Indian compliance and the
                      accounting standards used across the US, UK, Australia and Canada. A
                      dedicated team is assigned to your engagement, so it gets real attention —
                      not one account among hundreds at a faceless outsourcing shop.
                    </p>
                  </div>
                </div>
              </Reveal>
          ...
          <div className="section-shell">
            <Reveal>
              ...
              <p className="mx-auto mt-4 max-w-lg text-sm leading-relaxed text-white/70 sm:text-base">
                A short call to understand your workflow, volumes and tools, and whether
                outsourcing makes sense for your firm right now.
              </p>
              <Link
                to="/contact"
